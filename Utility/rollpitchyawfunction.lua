...
-- Test function to print Pitch, Yaw, and Roll
local function printOrientation()
    local pitch = math.deg(getPitch()) -- Convert to degrees
    local yaw = math.deg(getYaw())     -- Convert to degrees
    local roll = math.deg(getRoll())   -- Convert to degrees

    print("Ship Orientation:")
    print("Pitch: " .. string.format("%.2f", pitch) .. "degree")
    print("Yaw: " .. string.format("%.2f", yaw) .. "degree")
    print("Roll: " .. string.format("%.2f", roll) .. "degree")
end

-- Example: Call the test function
printOrientation()
