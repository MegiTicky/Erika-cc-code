...
-----------------
--40mm bofors
local MAG_SIZE    = 5       -- rounds per magazine
local RELOAD_TIME = 0.5       -- seconds
local FIRE_RPM    = 140       -- rounds per minute
FIRE_RPM = FIRE_RPM * 2
local elevateTraverseSpeed = 10 -- angle per 0.5s
...
local cd = 0.999999
-- limitor
local minDepression, maxElevation = -30, 90
...
local Kp_yaw, Ki_yaw, Kd_yaw = 0.04, 0.02, 0.02
