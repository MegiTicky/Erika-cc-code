...
AntiAirChannel = askUser("Input the channel number",950)
...
local function moveCannon(yaw, pitch, firing, convDist)
    ...
    if pitch > maxElevation then pitch = maxElevation end
    if pitch < minDepression then pitch = minDepression end
