...
local engineLeft = peripheral.wrap("left")
local engineRight = peripheral.wrap("right")
...
if not engineLeft then
    error("Left rotation controller not found")
elseif not engineRight then
    error("Right rotation controller not found")
...
parallel.waitForAny(
    listenForCoordinates,updateSpeed, updateYaw, updateLeftSpeed, updateRightSpeed, updateTurnLevel,
    function()
        while true do
            local statusData = {}
            ...
            -- Engine speeds
            statusData.leftSpeed = leftSpeed
            statusData.rightSpeed = rightSpeed
            ...
            -- Engine control
            engineLeft.setTargetSpeed(leftSpeed)
            engineRight.setTargetSpeed(rightSpeed)
