...
local cannonHitPosChannel = 500
local cannonSourceChannel = 501
local cannonSource 
...
local configFile = "jarvisNGDWconfig.txt"
...
local function aimCannon(targetPos, targetVel, sourceX, sourceY, sourceZ, currentPitch, currentYaw)
    if sourceX and sourceY and sourceZ and currentPitch and currentYaw then
        ...
        pitch = pitch + findBestPitch(estimateX, estimateY, estimateZ, sourceX, sourceY, sourceZ, 330, 0.04, 0.99, 0.0028, 330)
