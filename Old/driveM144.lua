...
for i = 1, 200 do  -- Assuming there are 2 Create_RotationSpeedController peripherals
    left = peripheral.wrap("Create_RotationSpeedController_" .. i)
    if left then
        break
    end
end
    ...
    while true do
        ...
        elseif turnLevel == 2 then
            if currentLeft ~= 32 then
                left.setTargetSpeed(-80)
            end
            if currentRight ~= -32 then
                right.setTargetSpeed(80)
            end
        elseif turnLevel == -2 then
            if currentLeft ~= -32 then
                left.setTargetSpeed(80)
