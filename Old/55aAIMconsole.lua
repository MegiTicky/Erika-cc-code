...
local port5inchChannel = getChannelInput("Input the port side cannon data channel", 1900)
local starboard5inchChannel = getChannelInput("Input the starboard side cannon data channel", 1901)
local bow15inchChannel = getChannelInput("Input the bow cannon data channel", 1902)
local stern15inchChannel = getChannelInput("Input the stern cannon data channel", 1903)
